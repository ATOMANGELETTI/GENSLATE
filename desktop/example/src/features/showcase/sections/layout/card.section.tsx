import { Badge, Button, Card, CardBody, CardFooter, CardHeader, IconButton } from '@genslate/design-system';
import { Specimen } from '../../components/specimen.component';

export function CardSectionPage() {
  return (
    <>
      <Specimen title="Variants" description="Flat with a hairline at rest; raised only when it floats." stageClassName="grid grid-cols-3 items-stretch gap-5">
        <Card>
      ...
      <Specimen title="Composition" stageClassName="grid grid-cols-2 items-start gap-5">
        <Card>
          ...
          <CardBody className="flex items-center gap-2">
            ...
            <span className="text-sm text-fg-muted">Built in 38s</span>
          </CardBody>
          <CardFooter>
        ...
        <Card interactive tabIndex={0} role="button" aria-label="Open project GENSLATE">
          ...
          <CardBody className="text-sm text-fg-muted">Interactive cards get hover, press and a focus ring.</CardBody>
        </Card>
      </Specimen>
    </>
  );
